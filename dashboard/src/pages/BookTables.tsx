    ...
    try {
      ...
      await api.post(
        "/booking/createBookings",
        {
          ...
          start_time: startISO,
          end_time: endISO,
          type_of_table: "standard",   // adjust if your form should collect this
          booking_class: "regular",     // adjust if your form should collect this
        },
  ...
  if (success) {
    return (
      <div className="p-8 max-w-md mx-auto text-center">
        <h1 className="text-2xl font-serif mb-2">Booking Confirmed!</h1>
